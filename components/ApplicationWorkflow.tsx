...
export const ApplicationWorkflow: React.FC<ApplicationWorkflowProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-white font-body pt-24 pb-20 px-4 md:px-6 relative">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div key={index} className="flex flex-col items-center bg-brand-dark px-2">
                    <div 
                      className={`w-8 h-8 flex items-center justify-center rounded-full border text-xs font-mono transition-colors duration-300 ${
                        isActive ? 'border-brand-orange text-brand-orange bg-brand-orange/10' : 
